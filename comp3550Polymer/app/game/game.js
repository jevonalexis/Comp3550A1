...
//defining images
	...
	function images() {
		if(time < maxTime){
			...
			context.fillText("Time: " +time, 30, 10);
			context.fillText("Water drops saved: " +totalCollected, 500, 10);
		}
		else if(time > maxTime){
			result = endGame();
			context.fillStyle = "rgb(199, 231, 242)";
			context.textAlign = "left";
			context.textBaseline = "top";
			context.font ="32px Georgia";
			context.fillText(result, 10,250);
	...
	function endGame(){
		...
		//c="You have a long way to go.Saving the world begins with you";
